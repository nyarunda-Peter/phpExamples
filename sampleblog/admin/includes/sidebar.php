                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseUsers" aria-labelledby="users" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="register-add.php">Add Users</a>
                                    <a class="nav-link" href="view-registered.php">View Users</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="posts" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
